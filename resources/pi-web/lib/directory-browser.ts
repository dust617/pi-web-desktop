...
export function getParentDirectory(directory: string): string | null {
  // Host-platform path.resolve() turns POSIX input into backslash paths on
  // Windows. Choose the API from the supplied path so remote/serialized
  // POSIX paths retain their separator semantics.
