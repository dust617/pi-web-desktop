  ...
  const processImageFiles = useCallback(async (files: File[]) => {
    ...
    try {
      const newImages = (await Promise.all(
        imageFiles.map(
          (file) =>
            new Promise<AttachedImage | null>((resolve, reject) => {
              ...
              reader.onload = async () => {
                ...
                // If the payload is still empty after the fallback (lazy shell
                // virtual files where both FileReader and nativeImage yield
                // nothing), skip this file instead of resolving an empty blob
                // that would render as a transparent/blank thumbnail.
                if (!base64) {
                  console.warn("[ChatInput] Skipped image with no readable payload:", file.name || file.type);
                  return resolve(null);
                }
      ...
      )).filter((r): r is AttachedImage => r !== null);
                        ...
                        <div style={{ padding: "6px 8px", borderBottom: "1px solid var(--border)", flexShrink: 0 }}>
                          <input
                            ...
                            style={{
                              ...
                              background: "var(--bg-input, var(--bg))", border: "1px solid var(--border)",
